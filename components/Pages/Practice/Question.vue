<template>
  <div class="question">
    <p class="font-semibold text-lighter text-3xl">Mark the correct meaning</p>
    ...
    <div class="mt-16">
      <card-ui
        ...
        :disabled="!!value"
        :class="{
          'border-primary shadow-xl': !!value && option === data.answer
        }"
        @click="$emit('answer', option)"
      >
        <div class="py-1 flex items-center">
          <div
            class="selected rounded-lg p-2 h-8 w-8 border"
